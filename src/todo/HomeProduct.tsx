...
const HomeProduct : React.FC<HomeProductPropsExt> =  ({_id,name,description,producer,price,photo,latitude,longitude,onEdit,onLocate}) =>{
    return (
        <StyledIonItem >
            <StyledLabel onClick={() => onEdit(_id)}>
            ...
            <Button size="large" onClick={()=>onLocate(_id)}>Locate</Button>
        </StyledIonItem>
    );
};
